...
function Header() {
    ...
    return (
        <Nav variants={navVariants} initial="up" animate={headerAnimation}>
            <Col>
                <Logo
                ...
                <Items>
                    <Item>
                        <Link to="/">
                            Home
                            {homeMatch?.isExact ? <Circle layoutId="circle"></Circle> : null}
                        </Link>
                    </Item>
                    <Item>
                        <Link to="/tv">
                            Tv Shows
                            {tvMatch ? <Circle layoutId="circle"></Circle> : null}
                        </Link>
                    </Item>
                </Items>
            </Col>
